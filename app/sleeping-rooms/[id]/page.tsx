      ...
      <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: "#eff0f1" }}>
        <div className="text-center">
          ...
          <Link href="/sleeping-rooms">
            <Button className="bg-[#90856f] hover:bg-[#7a6f5f]">Back to Sleeping Rooms</Button>
          </Link>
        </div>
      </div>
    )
    ...
    <div className="relative">
      ...
      <main className="min-h-screen pt-20" style={{ backgroundColor: "#eff0f1" }}>
        <div className="max-w-7xl mx-auto px-6 py-12">
          <Link
            href="/sleeping-rooms"
            className="flex items-center gap-2 text-[#90856f] hover:text-[#7a6f5f] mb-8 font-semibold"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="bg-white p-8 shadow-lg border-t-4 border-[#90856f]">
                {/* Translated "Request Information" to French */}
