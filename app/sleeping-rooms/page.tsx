    ...
    <div className="relative">
      ...
      <main className="min-h-screen pt-24" style={{ backgroundColor: "#eff0f1" }}>
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          {/* Header Section */}
          <div className="mb-16">
            <h1 className="text-5xl md:text-6xl font-serif font-bold text-gray-900 mb-4">Sleeping Room Collection</h1>
            <div className="h-1 w-32 bg-[#90856f] mb-8"></div>
            <p className="text-lg text-gray-700 max-w-3xl leading-relaxed">
              Transform your bedroom with our exclusive collection of beds and sleeping furniture. Designed for comfort,
              ...
              <Link key={room.id} href={`/sleeping-rooms/${room.id}`}>
                <div className="group cursor-pointer bg-white overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                  ...
                  <div className="p-8">
                    ...
                    <p className="text-gray-700 text-base mb-6 leading-relaxed">{room.description}</p>
                    <div className="flex items-center justify-between">
                      <p className="text-[#90856f] font-bold text-2xl">{room.price}</p>
